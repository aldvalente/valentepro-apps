...
-- CreateIndex
CREATE INDEX "equipment_sportType_idx" ON "equipment"("sportType");
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_equipmentId_fkey" FOREIGN KEY ("equipmentId") REFERENCES "equipment"("id") ON DELETE CASCADE ON UPDATE CASCADE;
