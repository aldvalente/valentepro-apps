-- Schema for Sportbnb-like app
-- Creates tables: users, equipment, equipment_images, bookings
...
-- Note: overlapping booking prevention should be implemented at application level
-- or via exclusion constraints using range types and GiST indexes if desired.
